                ...
                <div className="container mx-auto px-4">
                    <div className="pb-12 flex flex-wrap items-center justify-between border-b border-gray-800">
                        <div className="w-full lg:w-1/5 mb-12 lg:mb-4">
                            <a className="inline-block text-3xl text-white font-bold leading-none" href="#">
                                Design<span className='text-green-600'>AGENCY</span>
                            </a>
                        </div>
                        <div className="w-full lg:w-auto">
                            <ul className="flex flex-wrap lg:space-x-5 items-center">
                                <li className="w-full md:w-auto mb-2 md:mb-0">
                                    <Link className="lg:text-sm text-white hover:text-gray-300" href={"/"}>
                                        Start
                                    </Link>
                                </li>
                                ...
                                <li className="w-full md:w-auto mb-2 md:mb-0">
                                    <Link className="lg:text-sm text-white hover:text-gray-300" href={"/team"}>
                                        Team
                                    </Link>
                                </li>
                                <li className="hidden md:block">
                                ...
                                <li className="w-full md:w-auto mb-2 md:mb-0">
                                    <Link className="lg:text-sm text-white hover:text-gray-300" href={"/services"}>
                                        Services
                                    </Link>
                                </li>
                                <li className="hidden md:block">
                                ...
                                <li className="w-full md:w-auto mb-2 md:mb-0">
                                    <Link className="lg:text-sm text-white hover:text-gray-300" href={"/projects"}>
                                        Projects
                                    </Link>
                                </li>
                                <li className="hidden md:block">
                                ...
                                <li>
                                    <Link className="lg:text-sm text-white hover:text-gray-300"
                                          href={"/testimonials"}>
                                        Testimonials
                                    </Link>
                                </li>
                    ...
                    <div className="mt-8 flex flex-wrap justify-between items-center">
                        <p className="order-last text-sm text-white">© 2023. All rights reserved.
                        </p>
